...
@Composable
fun Success1(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.do_success_success_1),
        contentScale = ContentScale.Crop,
        modifier = modifier.requiredWidth(143.0.dp).requiredHeight(141.0.dp)
    )
}
